...
from modules.loss import compute_loss, compute_mlc_loss
...
def parse_agrs():
    ...
    parser.add_argument('--image_dir_test', type=str, default='data/mimic_cxr/images/',
                        help='the path to the directory containing the data for test.')
    parser.add_argument('--ann_path', type=str, default='data/mimic_cxr',
                        help='the path to the directory containing the data.')
    ...
    parser.add_argument('--num_layers_shared', type=int, default=1, help='the number of layers of Transformer - mutual layer.')
    ...
    parser.add_argument('--cls_weight', type=float, default=30.0, help='the weight for classification loss.')
    parser.add_argument('--cnt_weight', type=float, default=1.0, help='the weight for contrastive loss.')
...
def main():
    ...
    args.n_pathologies = train_dataloader.dataset.n_pathologies
    model = BaseCMNModel(args, tokenizer)

    # get function handles of loss and metrics
    criterion = (compute_loss, compute_mlc_loss)
